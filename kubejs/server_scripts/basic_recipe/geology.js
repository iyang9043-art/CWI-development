ServerEvents.recipes(event => {
  ...
  event.custom({"type":"vintageimprovements:centrifugation","ingredients": [{"item": "kubejs:claystone_dust"},{"item": "kubejs:claystone_dust"}],"results": [{"item": "kubejs:stone_dust","count": 1},{"item": "kubejs:clay_dust","count": 1}],"processingTime": 10})

  event.custom({"type":"lychee:item_inside","item_in":{"item":"kubejs:dark_ash_dust"},"block_in":{"blocks":["water"],"state":{"level":0}},"post":[{"type":"drop_item","item":"kubejs:ash_dust","contextual":{"type":"chance","chance":0.3}}]})
  ...
  event.custom({
    ...
    "post": [
      ...
      {
        "type": "place",
        "block": "darkerdepths:mossy_grimestone"
      },
      {
        "type": "damage_item"
      }
  ...
  event.custom({
    ...
    "post": [
      {
        "type": "place",
        "block": "kubejs:soaked_depleted_dirt"
      }
    ]
  })
